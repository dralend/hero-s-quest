...
@export var hit_audio: AudioStream = preload("uid://x3ky0na21gal")
@export var destroyed_audio: AudioStream = preload("res://assets/audio/audio/break_wood.wav")
...
func _on_damage_taken(attack_area: AttackArea) -> void:
	...
	if hp > 0:
		...
		Audio.play_spatial_sound(destroyed_audio, pos)
