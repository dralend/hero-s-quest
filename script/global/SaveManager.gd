...
func _ready() -> void:
	load_configuration()
	SceneManager.scene_entered.connect(_on_scene_enterd)
	pass
...
func load_game(slot: int) -> void:
	...
	var scene_path: String = save_data.get("scene_path", "uid://q4je7fq7nedp")
...
func is_area_discoverd(scene_uid: String) -> bool:
	return discovered_areas.has(scene_uid)


func _on_scene_enterd(scene_uid: String) -> void:
...
func load_configuration() -> void:
	...
	AudioServer.set_bus_volume_linear(4, config.get_value("audio", "ui", 0.8))
	pass
