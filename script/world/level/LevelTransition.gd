@tool
@icon ("res://assets/world/level_transition.svg")
...
@export var location: SIDE = SIDE.LEFT:
	set(value):
		location = value
		apply_area_settings()
@export var target_erea_name:  String = "LevelTransition"
...
func _on_player_entered(_n: Node2D) -> void:
	SceneManager.transition_scene(target_level, target_erea_name, get_offset(_n), get_transition_direction())
	pass
